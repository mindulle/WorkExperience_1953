      ...
      <main className="flex-1 flex flex-col gap-6 overflow-y-auto pr-4 pb-4">
        ...
        <div className="grid grid-cols-3 gap-6 flex-1">
          ...
          <Card className="col-span-1 flex flex-col">
            <h3 className="text-2xl font-bold mb-4">😊 감성 분석 (긍/부정)</h3>
            <div className="flex-1 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-full w-48 h-48 mx-auto my-4 relative">
              ...
              <svg viewBox="0 0 100 100" className="w-full h-full transform -rotate-90 opacity-30">
                <circle cx="50" cy="50" r="40" fill="transparent" stroke="#3b82f6" strokeWidth="20" strokeDasharray="200 50" />
                <circle cx="50" cy="50" r="40" fill="transparent" stroke="#ef4444" strokeWidth="20" strokeDasharray="50 200" strokeDashoffset="-200" />
              </svg>
            </div>
            <div className="flex justify-around mt-4 text-xl">
              <span className="text-blue-600 font-bold">긍정 80%</span>
              <span className="text-red-500 font-bold">부정 20%</span>
            </div>
          </Card>
          ...
          <Card className="col-span-1 flex flex-col">
            ...
            <div className="flex flex-col gap-4 mt-2">
              <Progress value={85} label="1위. 수육백반 (85%)" />
              <Progress value={65} label="2위. 맛보기 순대 (65%)" />
              <Progress value={40} label="3위. 섞어국밥 (40%)" />
              <Progress value={25} label="4위. 내장국밥 (25%)" />
            </div>
          </Card>
          ...
          <Card className="col-span-1 flex flex-col">
            ...
            <div className="flex-1 flex items-center justify-center border-2 border-dashed border-gray-300 rounded-full w-48 h-48 mx-auto my-4 relative">
              ...
              <svg viewBox="0 0 100 100" className="w-full h-full transform -rotate-90 opacity-30">
                <circle cx="50" cy="50" r="40" fill="transparent" stroke="#10b981" strokeWidth="20" strokeDasharray="120 130" />
                <circle cx="50" cy="50" r="40" fill="transparent" stroke="#f59e0b" strokeWidth="20" strokeDasharray="80 170" strokeDashoffset="-120" />
                <circle cx="50" cy="50" r="40" fill="transparent" stroke="#6366f1" strokeWidth="20" strokeDasharray="50 200" strokeDashoffset="-200" />
              </svg>
            </div>
            <div className="flex justify-around mt-4 text-lg">
              <span className="text-green-600">관광 48%</span>
              <span className="text-yellow-600">데이트 32%</span>
              <span className="text-indigo-600">일상 20%</span>
            </div>
          </Card>
          ...
          <div className="col-span-1 flex flex-col gap-6">
            ...
            <Card className="flex-1">
              ...
              <ol className="list-decimal list-inside text-xl space-y-1 ml-4 text-gray-700">
                <li className="font-bold text-gray-900">친절한 서비스</li>
                <li>깔끔한 국물</li>
                <li>넓은 주차장</li>
                <li>가족 외식</li>
                <li>혼밥 추천</li>
